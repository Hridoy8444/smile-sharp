...
import logo from '../../../Images/Logo/logo-2_.png'
                ...
                <Container>
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        ...
                        <Nav>
                            ...
                            {
                                user ?
                                <Nav.Link onClick={handleLogOut} className='nav-container' as={Link} to='/login'>Logout   <img  src={user.photoURL} alt="" /></Nav.Link>
                                :
